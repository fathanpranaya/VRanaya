...
// Modified by: Fathan Adi Pranaya
// 
if (navigator.getVRDisplays) {
	...
	navigator.getVRDisplays().then(function (displays) {
		if (displays.length > 0) {
			...
			// alert("WebVR supported");
		} else {
			alert("WebVR supported, but no VRDisplays found.", 3000);
		}
	});
...
jsmpeg.prototype.initWebGL = function() {
	...
	this.identityMatrix = mat4.identity(this.identityMatrix);
	...
	gl.uniformMatrix4fv(this.matViewUniformLocation, gl.FALSE, this.identityMatrix);
	gl.uniformMatrix4fv(this.matProjUniformLocation, gl.FALSE, this.identityMatrix);
...
jsmpeg.prototype.updateTexture = function () {
	gl.pixelStorei
}
